            ...
            body: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    _container(context, MainColors.color76B226_15, "broccoli"),
                    _container(context, MainColors.colorEA812F_15, "carrot"),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border:
                            Border.all(color: MainColors.darkGrey, width: 1),
                      ),
                      child: Text(
...
//! red button
      ...
      children: [
        Text(
          ...
          style: MyTextStyleComp.myTextStyle(
            color:
                color != null ? MainColors.color92929D : MainColors.colorBlackk,
            fontSize: 18,
  ...
  Container _container2(BuildContext context, Widget child) {
    return Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: MainColors.darkGrey, width: 1),
      ),
      child: child,
    );
  }
  ...
  ElevatedButton _elevatedButton(BuildContext context) {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        ...
        shape: RoundedRectangleBorder(
          side: BorderSide(color: MainColors.darkPink, width: 1),
          borderRadius: BorderRadius.circular(100),
        ),
      ),
      child: Row(
        ...
        children: [
          Text(
            'Add more',
            style: MyTextStyleComp.myTextStyle(
              color: MainColors.darkPink,
              fontSize: 16,
              weight: FontWeight.w700,
            ),
          ),
          Icon(Icons.add, color: MainColors.darkPink),
        ],
      ),
      onPressed: () {
