...
import 'package:organico/service/organico_service.dart';
import 'package:organico/view/screens/cart/view/cart_view.dart';
            ...
            children: [
              Text(
                ...
                style: MyTextStyleComp.myTextStyle(
                    color: MainColors.color696974, fontSize: 15),
              ),
              Row(
                ...
                children: [
                  Text(
                    "User, Location",
                    style: MyTextStyleComp.myTextStyle(
                        color: MainColors.colorBlackk, fontSize: 18),
                  ),
                ],
              ),
              InkWell(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: MainColors.colorF1F1F5),
                  child: Row(
                    children: [
                      Icon(Icons.search, color: MainColors.color92929D),
                      const SizedBox(width: 12),
                      Text(
                        "Search doctors by name or position",
                        style: MyTextStyleComp.myTextStyle(
                            color: MainColors.color92929D, fontSize: 16),
                      ),
              ...
              Row(
                ...
                children: [
                  ...
                  InkWell(
                    child: _category(
                        context, "banana", "Fruits", MainColors.colorF3A20C_15),
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                  ...
                  InkWell(
                    child: _category(
                        context, "meat", "Meats", MainColors.colorFE706E_25),
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
              ...
              FutureBuilder(
                ...
                builder: ((context, AsyncSnapshot<List<OrganicoApiModel>> snapshot) {
                  if (!snapshot.hasData) {
                    return const Center(
